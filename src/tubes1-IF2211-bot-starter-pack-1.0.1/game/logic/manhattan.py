...
# Template objek Manhattan dengan inheritance dari BaseLogic
class Manhattan(BaseLogic):
    ...
    def find_nearest_cell(
        ...
        # Mencari diamond dengan manhattan distance paling kecil dari starting point
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        # Kondisi untuk balik ke base: Jika waktu akan habis atau inventory sudah full
        if (
        ...
        if self.goal_position:
            ...
            # Kasus goal sudah bukan object game board atau bot masuk teleport
            else:
